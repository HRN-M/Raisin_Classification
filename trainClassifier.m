...
% Auto-generated by MATLAB on 25-Sep-2025 12:06:52
...
predictorNames = {'Area', 'MajorAxisLength', 'MinorAxisLength', 'Eccentricity', 'ConvexArea', 'Extent', 'Perimeter'};
predictors = inputTable(:, predictorNames);
response = inputTable.Class;
isCategoricalPredictor = [false, false, false, false, false, false, false];
classNames = categorical({'Besni'; 'Kecimen'});
...
trainedClassifier.RequiredVariables = {'Area', 'MajorAxisLength', 'MinorAxisLength', 'Eccentricity', 'ConvexArea', 'Extent', 'Perimeter'};
